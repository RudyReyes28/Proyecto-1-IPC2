...
public class ConectarAdminBodega {
    
    public static void conectarAdminBodegas(){
        ...
        for (int codigoA : codigoAdmin) {
                ...
                for (int codigoU : codigoUsuario) {
                    try {
                        ...
                        ps = conexion.prepareStatement("INSERT INTO admin_bodega(codigo_admin,codigo_bodega) VALUES (?,?)");
                        ps.setInt(1, codigoA);
                        ps.setInt(2, codigoU);
                        ps.executeUpdate();
                        ps.close();
