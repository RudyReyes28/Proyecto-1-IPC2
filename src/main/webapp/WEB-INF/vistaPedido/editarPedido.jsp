<%-- 
    ...
    Created on : 17 mar. 2023, 12:08:23
    Author     : rudy-reyes
--%>
...
<html>
    ...
    <body>
        ...
        <form action="${pageContext.request.contextPath}/ServletControladorPedido?accion=modificar"
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <div class="form-group">
                                        ...
                                        <input type="number" class="form-control" name="idPedido" value="${productoP.idPedido}" readonly>
                                    </div>
                                    <div class="form-group">
