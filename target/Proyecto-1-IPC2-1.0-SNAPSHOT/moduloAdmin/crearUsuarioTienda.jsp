<%-- 
    Document   : crearUsuarioTienda
    Created on : 20 mar. 2023, 14:12:02
    Author     : rudy-reyes
--%>
    ...
    <body>
        <header id="main-header" class="py-2 bg-info text-white">
            <div class="container">
                <div class="row">
                    <div class="col-md-6">
                        <h1></i>Creacion Usuario Tienda</h1>
                    </div>
                </div>
            </div>
        </header>

        <form action="${pageContext.request.contextPath}/ServletCreacionUsuarios?accion=uTienda"
              method="POST">
            ...
            <div class="row container">
                ...
                <div class="form-floating mb-3" style="border: 2px solid cornflowerblue">
                    <select name="tienda" class="form-select" id="floatingSelect" aria-label="Floating label select example">
                        <c:forEach var="tiendas" items="${tiendas}">
                            <option value="${tiendas}">${tiendas}</option>
                        </c:forEach>
                    </select>
                    <label for="floatingSelect">Seleccione la tienda</label>
                </div>
