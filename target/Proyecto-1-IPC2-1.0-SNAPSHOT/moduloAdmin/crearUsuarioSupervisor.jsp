<%-- 
    Document   : crearUsuarioSupervisor
    Created on : 21 mar. 2023, 0:10:33
    Author     : rudy-reyes
--%>
    ...
    <body>
        <header id="main-header" class="py-2 bg-info text-white">
            <div class="container">
                <div class="row">
                    <div class="col-md-6">
                        <h1></i>Creacion Usuario Supervisor</h1>
                    </div>
                </div>
            </div>
        </header>

        <form action="${pageContext.request.contextPath}/ServletCreacionUsuarios?accion=uSupervisor"
              method="POST">
