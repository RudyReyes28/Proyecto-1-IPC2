        ...
        <div class="row">
            <div class="col-md-9">
                <div class="card">
                    ...
                    <form action="${pageContext.request.contextPath}/ServletCrearIncidencias?accion=enviar"
                                ...
                                <c:forEach var="producto" items="${listado}" varStatus="status" >
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a href="${pageContext.request.contextPath}/ServletCrearIncidencias?accion=eliminar&codigoP=${producto.codigo}"
