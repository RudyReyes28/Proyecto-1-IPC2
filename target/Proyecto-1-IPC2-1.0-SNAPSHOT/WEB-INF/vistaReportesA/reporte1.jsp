<%-- 
    Document   : reporte1
    Created on : 21 mar. 2023, 15:29:22
    Author     : rudy-reyes
--%>
...
<html>
    ...
    <body>
        <form action="${pageContext.request.contextPath}/ServletAdminReportes?accion=verReporte1"
              method="POST">
            ...
            <div class="row ">
                ...
                <div class="form-group">
                    <button class="btn btn-primary" type="submit">Tiendas</button>
                </div>   
            </div>
                            ...
                            <table class="table table-striped">
                                ...
                                <tbody>
                                    ...
                                    <c:forEach var="pedido" items="${listado}" varStatus="status" >
                                        <tr>
                                            <td>${status.count}</td>
                                            <td>${pedido.codigoTienda}</td>
                                            <td>${pedido.cantPedidos}</td>
                                        </tr>
                                    </c:forEach>
                                </tbody>
                            </table>
        ...
        <div class="col-md-3 justify-content-md-end">
            <a href="${pageContext.request.contextPath}/ServletAdminReportes?accion=regresar" class="btn btn-danger btn-block">
                Regresar
            </a>
        </div>
