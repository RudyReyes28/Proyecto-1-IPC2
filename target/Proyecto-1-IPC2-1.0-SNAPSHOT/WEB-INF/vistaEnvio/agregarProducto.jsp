...
<div class="modal fade" id="agregarProductoModal">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <form action="${pageContext.request.contextPath}/ServletControladorEnvios?accion=insertar"
                  method="POST" class="was-validated">
                
                <div class="modal-body">
                    <div class="form-group">
                        <label for="idPedio">ID Envio</label>
                        <input type="number" class="form-control" name="idEnvio" value="${idEnvio}" readonly>
                    </div>
                    <div class="form-group">
